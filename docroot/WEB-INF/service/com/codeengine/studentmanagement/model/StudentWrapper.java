...
public class StudentWrapper implements Student, ModelWrapper<Student> {
	...
	*/
	...
	@Override
	public int compareTo(com.codeengine.studentmanagement.model.Student student) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.codeengine.studentmanagement.model.Student> toCacheModel() {
		return _student.toCacheModel();
	}

	@Override
	public com.codeengine.studentmanagement.model.Student toEscapedModel() {
		return new StudentWrapper(_student.toEscapedModel());
	}

	@Override
	public com.codeengine.studentmanagement.model.Student toUnescapedModel() {
