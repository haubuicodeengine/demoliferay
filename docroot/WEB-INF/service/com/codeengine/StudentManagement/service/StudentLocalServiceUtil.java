...
public class StudentLocalServiceUtil {
	...
	*/
	public static com.codeengine.StudentManagement.model.Student addStudentManual(
		java.lang.String name, java.lang.String email)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().addStudentManual(name, email);
	}
	...
	*/
	public static com.codeengine.StudentManagement.model.Student updateStudent(
		...
		throws com.codeengine.StudentManagement.NoSuchStudentException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().updateStudent(studentId, name, email);
	}
