...
/**
 * Provides the local service interface for Clazz. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ces
 * @see ClazzLocalServiceUtil
...
public interface ClazzLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClazzLocalServiceUtil} to access the clazz local service. Add custom service methods to {@link com.codeengine.service.service.impl.ClazzLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
