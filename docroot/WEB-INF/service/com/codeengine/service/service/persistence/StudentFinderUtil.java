...
public class StudentFinderUtil {
	...
	public static java.util.List<com.codeengine.service.model.Student> findByNameDynamicQuery(
	...
	public static StudentFinder getFinder() {
		if (_finder == null) {
			_finder = (StudentFinder)PortletBeanLocatorUtil.locate(com.codeengine.service.service.ClpSerializer.getServletContextName(),
