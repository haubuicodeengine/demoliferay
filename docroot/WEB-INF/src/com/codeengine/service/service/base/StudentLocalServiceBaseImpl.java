...
import com.codeengine.service.service.StudentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.codeengine.service.service.impl.StudentLocalServiceImpl}.
 * </p>
 *
 * @author ces
...
public abstract class StudentLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.codeengine.service.service.StudentLocalServiceUtil} to access the student local service.
	 */
	...
	public Student createStudent(long userId) {
		return studentPersistence.create(userId);
	}
	...
	public Student deleteStudent(long userId)
		...
		return studentPersistence.remove(userId);
	}
	...
	@Override
	public Student fetchStudent(long userId) throws SystemException {
		return studentPersistence.fetchByPrimaryKey(userId);
	}
	...
	public Student getStudent(long userId)
		...
		return studentPersistence.findByPrimaryKey(userId);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.codeengine.service.model.Student",
			studentLocalService);
	}
