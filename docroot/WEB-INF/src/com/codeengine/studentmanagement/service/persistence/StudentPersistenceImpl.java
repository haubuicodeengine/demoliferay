...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	 ...
	 */
	@Override
	public Student[] findByUuid_C_PrevAndNext(long userId, String uuid,
	 ...
	 */
	@Override
	public List<Student> filterFindByUuid_C(String uuid, long companyId)
		throws SystemException {
	 ...
	 */
	@Override
	public Student[] filterFindByUuid_C_PrevAndNext(long userId, String uuid,
		long companyId, OrderByComparator orderByComparator)
		throws NoSuchStudentException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByUuid_C_PrevAndNext(userId, uuid, companyId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByUuid_C_PrevAndNext(session, student, uuid,
					companyId, orderByComparator, true);

			array[1] = student;

			array[2] = filterGetByUuid_C_PrevAndNext(session, student, uuid,
					companyId, orderByComparator, false);
	...
	protected Student filterGetByUuid_C_PrevAndNext(Session session,
		Student student, String uuid, long companyId,
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1_SQL = "student.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2_SQL = "student.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3_SQL = "(student.uuid_ IS NULL OR student.uuid_ = '') AND ";
